...
def main():
    ...
    circle3 = Circle.create_by_diameter(1, 2, 8)
    circle4 = Circle.create_by_diameter(3, 4, 10)

    print(Circle.get_count())

    circle1.color = '#00FF00'   # Изменить цвет только circle1
    Circle.set_color('#FF0000')   # Изменить цвет всем объектам класса Circle

    print(circle1.color)  # Тут есть параметр color
    print(circle2.color)  # Тут нет параметра color
